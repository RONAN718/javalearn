...
import io.kimmking.rpcfx.client.RpcAopfx;
...
public class RpcfxClientApplication {
	...
	public static void main(String[] args) {
		...
		UserService userService = RpcAopfx.create(UserService.class, "http://localhost:8080/");
		User user = userService.findById(1000000000);
		System.out.println("find user id=0 from server: " + user.getName());
